      ...
      >
        ...
        >
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
            <span style={{ fontSize: 20, fontWeight: 700, color: COLORS.textPrimary }}>New Class</span>
          ...
          <input type="text" placeholder="e.g. Calculus II" value={name}
            onChange={(e) => setName(e.target.value)} style={webStyles.input} />

          <label style={webStyles.label}>COURSE CODE</label>
          <input type="text" placeholder="e.g. MATH201" value={courseCode}
            onChange={(e) => setCourseCode(e.target.value.toUpperCase())} style={webStyles.input} />

          <label style={webStyles.label}>ROOM</label>
          <input type="text" placeholder="e.g. Room 204" value={room}
            onChange={(e) => setRoom(e.target.value)} style={webStyles.input} />
          ...
          {selectedDays.length === 0 && (
            <div style={{ fontSize: 12, color: COLORS.danger, marginTop: 4, marginBottom: 4 }}>
        ...
        >
          <View style={styles.card}>
            ...
            <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ padding: 24, paddingTop: 8 }}>
              ...
              <TextInput style={styles.input} placeholder="e.g. Calculus II"
                placeholderTextColor={COLORS.textMuted} value={name} onChangeText={setName} />

              <Text style={styles.label}>Course Code</Text>
              <TextInput style={styles.input} placeholder="e.g. MATH201"
                placeholderTextColor={COLORS.textMuted} value={courseCode}
                onChangeText={setCourseCode} autoCapitalize="characters" />

              <Text style={styles.label}>Room</Text>
              <TextInput style={styles.input} placeholder="e.g. Room 204"
                placeholderTextColor={COLORS.textMuted} value={room} onChangeText={setRoom} />
